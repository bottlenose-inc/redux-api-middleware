...
function fetchPollingQueued(endpoint, _ref2, options) {
  ...
  var retries, retriesSoFar, pollDelay, res, status;
  return _regeneratorRuntime.async(function fetchPollingQueued$(context$1$0) {
    while (1) switch (context$1$0.prev = context$1$0.next) {
      ...
      case 1:
        ...
        retriesSoFar = options.queuedRetries - retries - 1;
        pollDelay = options.falloff ? falloff(options.minimumPollInterval, options.maximumPollInterval, options.falloffSteps, retriesSoFar) : options.maximumPollInterval;
        context$1$0.next = 6;
      ...
      case 9:
        ...
        context$1$0.next = 13;
        return _regeneratorRuntime.awrap(_util.delay(pollDelay));
